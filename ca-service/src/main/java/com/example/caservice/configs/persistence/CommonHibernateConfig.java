...
import com.tct.bccs.ca.common.utils.CommonUtils;
...
public class CommonHibernateConfig {
    ...
    public Properties hibernateProperties() {
        ...
        hibernateProperties.setProperty("hibernate.connection.CharSet", CommonUtils.getNonNullPropertyOrThrow(env, "hibernate.connection.CharSet"));
        hibernateProperties.setProperty("hibernate.connection.characterEncoding", CommonUtils.getNonNullPropertyOrThrow(env, "hibernate.connection.characterEncoding"));
        hibernateProperties.setProperty("hibernate.connection.useUnicode", CommonUtils.getNonNullPropertyOrThrow(env, "hibernate.connection.useUnicode"));
